...
public interface MxstarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code idExpt}
	 * labeled alternative in {@link MxstarParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterIdExpt(MxstarParser.IdExptContext ctx);
	/**
	 * Exit a parse tree produced by the {@code idExpt}
	 * labeled alternative in {@link MxstarParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitIdExpt(MxstarParser.IdExptContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code subsriptExpr}
	 * labeled alternative in {@link MxstarParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterSubsriptExpr(MxstarParser.SubsriptExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code subsriptExpr}
	 * labeled alternative in {@link MxstarParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitSubsriptExpr(MxstarParser.SubsriptExprContext ctx);
	/**
